...
# MAGIC - **min_provisioned_throughput**: Minimum model units
# MAGIC (must be 0 if scale_to_zero enabled)
...
def get_endpoint_metrics(endpoint_name: str) -> Any | None:  # noqa: ANN401
