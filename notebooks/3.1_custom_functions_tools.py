...
# MAGIC %pip install /Workspace/Users/nathalie-frisch@gmx.de/.bundle/llmops-databricks-course-nathalie-vishal-adriane/dev/files
...
metric_delta_tool = ToolInfo(
    name="metric_delta",
    spec=metric_delta_tool_spec,
    exec_fn=metric_delta
)
...
calc_result = registry.execute("metric_delta", {
    "baseline": 1000,
    "comparison": 1005
})
...
response = agent.chat("- If last year's sales were 1000 and this year's are 1100, what is the delta?")
